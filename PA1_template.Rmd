...
ggplot(data=ww,aes(x=interval,y=avg_steps)) + geom_line(colour='red') + facet_wrap(~w_class, scales="free",  nrow = 2) +labs( title="Activity Patterns", y="Frequency in dataset", x="# average steps")
```